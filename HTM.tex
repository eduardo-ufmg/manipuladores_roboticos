...
\title{Produto Equivalente a Uma Matriz de Transformação Homogênea}
\author{}
\date{}
...
O que implica em $\mathbf{Q} = k\mathbf{Q}$, o que requer $k = 1$. No entanto, isso contradiz a condição de que $\mathbf{M} \neq \mathbf{T}$. Portanto, $\mathbf{M}$ e $\mathbf{T}$ são linearmente independentes.
